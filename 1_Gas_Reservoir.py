...
forcheimer= (''' Forcheimer Reservoir Model: The Forcheimer equation expresses the inflow performance in terms of turbulent and non turbulent pressure drop coefficients expressed as:
...
def collect_data():
    ...
    while True:
        ...
        another = input("Do you want to enter another data point? (yes/no): ").lower()
        if another != 'yes':
            break
