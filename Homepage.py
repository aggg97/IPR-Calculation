...
with col3:
    ...
    st.markdown("By uploading a .csv file with test data from different wells, IPR calculation will be done with either Forcheimer's or Vogel's IPR cuadratic equation")
